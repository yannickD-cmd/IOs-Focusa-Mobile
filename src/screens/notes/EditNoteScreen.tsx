...
export default function EditNoteScreen() {
  ...
  const { notes, updateNote, isLoading } = useNotesStore();
  ...
  const [selectedProjectId, setSelectedProjectId] = useState<string | null>(note?.project_id || null);

  useEffect(() => {
    if (!note) {
      Alert.alert('Erreur', 'Note non trouvée');
      navigation.goBack();
    }
  }, [note]);
